...
public class CustomerController {
	...
	public ResponseEntity<Customer> getCustomerByCustomerId(@PathVariable(value = "customerId") String customerId) throws ResourceNotFoundException {
	...
	public ResponseEntity<?> createCustomer(@RequestBody Customer customer) {
		try {
			// FIXED : Add logic to Hash Customer PIN here
			// FIXED : Add logic to check if Customer with provided username, or
			// customerId exists. If exists, throw a Customer with [?] exists
			// Exception.
            String customerPin= passwordEncoder.encode(customer.getPin());
	...
	private String generateAccountNo(String customerId) {
		// FIXED : Add logic here - generate a random but unique Account No (NB:
