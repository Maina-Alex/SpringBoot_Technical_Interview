...
public class AccountController {
	...
	public ResponseEntity<?> getAccountBalanceByCustomerIdAndAccountNo(@RequestBody String request)
		...
		try {
			...
			//FIXED: Add logic to find account balance by CustomerId And
			// AccountNo
			Account account=accountRepository.findAccountByCustomerId(customerId).orElseThrow(()->new ResourceNotFoundException("Customer account not found"));
